...
async def searchable_fields(user=Depends(get_current_user)):
    ...
    labels = {
        "source": "Nome sorgente configurata",
        "source_type": "Famiglia parser (windows_event, zeek, suricata, firewall…)",
        "severity": "INFO | LOW | MEDIUM | HIGH | CRITICAL",
        "hostname": "Host che ha generato l'evento",
        "ip": "IP dell'evento",
        ...
        "protocol": "Protocollo normalizzato (tcp/udp/icmp)",
        "process_name": "Nome processo",
        "file_name": "Nome file",
        "file_path": "Percorso file",
        "domain": "Dominio/host applicativo",
        "dns_query": "Query DNS",
        "signature": "Firma IDS o provider",
        "signature_id": "ID della firma/EventID",
        "category": "Categoria della sorgente",
        "message_id": "EventID / message id",
        "url": "URL richiesto",
        "http_method": "Metodo HTTP",
        "http_status": "Codice di stato HTTP",
        "event_id": "Identificativo del singolo evento (dedup)",
    }
